...
@DynamicInsert
@DynamicUpdate
@Table(name="ADDRESS_BUILDING_TYPES")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class AddressBuildingType implements Serializable {
    ...
    @OneToMany(mappedBy = "addressFactBuildingType")
    private Set<Requisite> factRequisites;

    @OneToMany(mappedBy = "addressLegalBuildingType")
    private Set<Requisite> legalRequisites;

    @Override
    public String toString() {
        return "ADDRESS_BUILDING_TYPE [id=" + id + ", NAME_FULL=" + nameFull + ", NAME_SHORT=" + nameShort + ", DESCRIPTION=" + description;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof AddressBuildingType))
            return false;
        AddressBuildingType other = (AddressBuildingType) obj;
        if (id == null) {
            if (other.id != null)
                return false;
