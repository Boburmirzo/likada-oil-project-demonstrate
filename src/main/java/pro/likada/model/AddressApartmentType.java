...
@DynamicInsert
@DynamicUpdate
@Table(name="ADDRESS_APARTMENT_TYPES")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class AddressApartmentType implements Serializable {
    ...
    @OneToMany(mappedBy = "addressFactApartmentType")
    private Set<Requisite> factRequisites;

    @OneToMany(mappedBy = "addressLegalApartmentType")
    private Set<Requisite> legalRequisites;

    @Override
    public String toString() {
        return "ADDRESS_APARTMENT_TYPE [id=" + id + ", NAME_FULL=" + nameFull + ", NAME_SHORT=" + nameShort + ", DESCRIPTION=" + description;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null)
            return false;
        if (!(obj instanceof AddressApartmentType))
            return false;
        AddressApartmentType other = (AddressApartmentType) obj;
        if (id == null) {
            if (other.id != null)
                return false;
